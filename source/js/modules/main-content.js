var MainContent = (function () {
  ...
  events.actualizarContenidoPrincipal = function () {
    var nom_boton_principal_activo = $(".grid__item.is-active").attr(
      "data-nom"
    );

    $(".MainContent").removeClass("is-visible");
    $('.MainContent[data-nom="' + nom_boton_principal_activo + '"]').addClass(
      "is-visible"
    );
  ...
  events.actualizarContenidoIProcedimientoPago = function (nombre_entidad) {
    var nom_boton_principal_activo_b2b = $(".MainContent.is-visible").attr(
      "data-nom"
    );
    // var nom_boton_principal_activo = $('.MainNav-item.is-active').attr('data-nom');

    var seccion_principal_activa_b2b = $(
      '.MainContent[data-nom="' + nom_boton_principal_activo_b2b + '"]'
    );
    ...
    var cambiarTicket = (function () {
      ...
      var boxGrupoTickets_b2b = seccion_principal_activa_b2b.find(
        ".Ticket[data-nom-entidad=" + nombre_entidad + "]"
      );
  ...
  return {
    ...
    actualizarContenidoIProcedimientoPago:
      events.actualizarContenidoIProcedimientoPago,
  };
})();
